"""
app/prompting/versioned_registry.py
...
from app.prompting.prompt_version import PromptVersion
...
class VersionedPromptRegistry:
    ...
    def _load_all(self) -> None:
        if not self._versions_dir.exists():
            return
        for prompt_dir in sorted(self._versions_dir.iterdir()):
...
versioned_registry = VersionedPromptRegistry()
